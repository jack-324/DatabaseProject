...
# Delete Data
            ...
            try:
                c.executemany("INSERT INTO Produkty (Nazwa,ilosc,opis,kod_kreskowy,ID_pracownika,Data_pomiaru) VALUES(?, ?, ?,?,0,?)",importdata)
                ...
                if "UNIQUE constraint failed" in str(e):
                    ...
                    c.executemany("UPDATE Produkty SET Nazwa = ?,ilosc = ?, opis = ?, kod_kreskowy = ?, ID_pracownika = 0, Data_pomiaru = ? WHERE kod_kreskowy = ?",importdata)
    ...
    0.Powrot""")
        ...
        if inp == str(0):
            ...
            try:
                ...
                print("Czy jest zatrudniony? " + str(x[4]))
                print("=========================")
                input("Wcisnij [ENTER] aby kontynuowac")
            except Exception as e:
                print(e)
            ...
            try:
                importdata = [inp]
                c.executemany("UPDATE Pracownicy SET Is_zatrudniony = 0 WHERE ID_pracownika = ?;",importdata)
                if c.rowcount < 1:
            ...
            try:
                c.executemany("INSERT INTO Pracownicy (Imie,Nazwisko,Data_zatrudnienia,Is_zatrudniony) VALUES(?, ?, ?,1)",importdata)
